...
Analyze the **researcher** codebase at **C:\Users\kazim\dac\researcher** and create/update intelligent, structure-based contexts in the SQLite database.

## Project Information

- **Project ID**: e1355549-1900-4f21-ab27-be493c58374d
- **Project Name**: researcher
- **Project Path**: C:\Users\kazim\dac\researcher
- **Project Type**: nextjs
- **Scan Timestamp**: 2026-01-03T18-55-23
...
- `PROJECT_ID` → e1355549-1900-4f21-ab27-be493c58374d
- `PROJECT_PATH` → C:\Users\kazim\dac\researcher
...
```bash
curl -X GET "http://localhost:3000/api/contexts?projectId=e1355549-1900-4f21-ab27-be493c58374d"
```
...
find "C:\Users\kazim\dac\researcher/src/app" -maxdepth 1 -type d -name "*-page" 2>/dev/null
find "C:\Users\kazim\dac\researcher/src/app/features" -maxdepth 1 -type d -name "sub_*" 2>/dev/null
```

### 3. Read High-Level Architecture (Optional)

```bash
cat "C:\Users\kazim\dac\researcher/context/high.md" 2>/dev/null || echo "No high-level architecture file found"
```
...
mkdir -p "C:\Users\kazim\dac\researcher/docs/contexts"

# Generate the report
cat > "C:\Users\kazim\dac\researcher/docs/contexts/scan-report-2026-01-03T18-55-23.md" << 'EOF'
# Context Scan Report

**Date**: 2026-01-03T18-55-23
**Project**: researcher
**Project ID**: e1355549-1900-4f21-ab27-be493c58374d
...
C:\Users\kazim\dac\researcher/docs/contexts/scan-report-2026-01-03T18-55-23.md
