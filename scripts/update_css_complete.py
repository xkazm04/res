#!/usr/bin/env python3
"""Update CSS with comprehensive styles matching component output."""
...
/* Findings Table */
.findings-table-container { overflow: hidden; }
.findings-table-container .component-title { margin: 0; }
.findings-table { width: 100%; border-collapse: collapse; font-size: var(--text-sm); }
.findings-table th { text-align: left; padding: var(--s-3) var(--s-4); background: var(--c-bg); font-size: 9px; font-weight: 600; color: var(--c-muted); text-transform: uppercase; border-bottom: 1px solid var(--c-border); }
.findings-table td { padding: var(--s-3) var(--s-4); border-bottom: 1px solid var(--c-border-light); vertical-align: top; }
.findings-table tr:hover td { background: var(--c-bg); }
.finding-type { white-space: nowrap; }
...
.finding-content-cell { max-width: 400px; }
.finding-content-cell strong { display: block; font-weight: 500; margin-bottom: 2px; color: var(--c-text); }
.finding-detail { display: block; font-size: var(--text-xs); color: var(--c-muted); line-height: 1.4; }
.finding-date { font-size: var(--text-xs); color: var(--c-text-faint); white-space: nowrap; }
.finding-confidence { text-align: center; }
.confidence-badge { display: inline-block; padding: 2px 6px; border-radius: 2px; font-size: 9px; font-weight: 600; font-family: var(--font-mono); }
...
.insight-item { display: flex; align-items: flex-start; gap: var(--s-3); padding: var(--s-3); background: var(--c-bg); border-radius: var(--r-md); }
.insight-item.insight-high { background: #fef9c3; }
.insight-icon { font-size: var(--text-md); }
.insight-text { flex: 1; font-size: var(--text-sm); line-height: 1.4; }
.insight-category { font-size: 9px; padding: 2px 6px; background: var(--c-border); border-radius: 2px; white-space: nowrap; }
...
.thesis-verdict { display: flex; align-items: center; gap: var(--s-4); padding: var(--s-4); border-radius: var(--r-md); color: #fff; }
.thesis-verdict.thesis-buy { background: linear-gradient(135deg, #059669, #047857); }
.thesis-verdict.thesis-hold { background: linear-gradient(135deg, #d97706, #b45309); }
.thesis-verdict.thesis-sell { background: linear-gradient(135deg, #dc2626, #b91c1c); }
.thesis-metrics { display: grid; grid-template-columns: repeat(4, 1fr); gap: var(--s-3); }
.thesis-metric { text-align: center; padding: var(--s-3); background: var(--c-bg); border-radius: var(--r-md); }
.thesis-cases { display: grid; grid-template-columns: 1fr 1fr; gap: var(--s-3); }
.bull-case, .bear-case { padding: var(--s-4); border-radius: var(--r-md); font-size: var(--text-xs); line-height: 1.4; }
...
.bull-case h4, .bear-case h4 { font-size: var(--text-xs); margin-bottom: var(--s-2); }
...
if __name__ == '__main__':
    ...
    print("CSS file updated with comprehensive styles matching component output")
